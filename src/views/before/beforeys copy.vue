<template>
    <div class="quanxian">
        ...
        <div class="desc">
            <van-checkbox class="checkbox" checked-color="#e1a08b" @click="doChange" v-model="$store.state.before.beforeys"
                shape="square">
...
export default {
    ...
    methods: {
        doChange() {
            this.$store.commit('before/changeyinsi')
        },
        doAgree() {
            if (this.$store.state.before.beforeys) {
                this.$router.push('/beforeqx')
            } else {
